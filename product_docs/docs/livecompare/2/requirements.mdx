...
-   Python 3.6 or 3.7
-   PostgreSQL / EDB Postgres Extended 9.5+ / EDB Postgres Advanced Server 13+ (on the output connection)
-   PostgreSQL / EDB Postgres Extended 9.4+ / EDB Postgres Advanced Server 13+ or Oracle 11g+ (on the data connections being compared)
...
You can use the following sample config for `TPAexec` to build a server with `LiveCompare` and `PostgreSQL 13`:
