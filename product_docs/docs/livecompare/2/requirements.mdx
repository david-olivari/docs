...
-   Python 3.6 or 3.7
-   PostgreSQL / EDB Postgres Extended 13+ / EDB Postgres Advanced Server 13+ (on the output connection)
-   PostgreSQL / EDB Postgres Extended 13+ / EDB Postgres Advanced Server 13+ or Oracle 11g+ (on the data connections being compared)
