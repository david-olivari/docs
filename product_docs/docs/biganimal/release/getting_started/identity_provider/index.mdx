...
When you have at least one verified domain, the identity provider status becomes **Active** on the **Identity Providers** tab. The status becomes **Inactive** when the domain is no longer verified. 
